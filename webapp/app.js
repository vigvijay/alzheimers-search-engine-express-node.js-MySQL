...
function handle_database(req, res) {
    ...
    pool.getConnection(function(err, connection) {
        ...
        connection.query("select s,p,o, count(o) as c from triples where " + triple1_query + " and " + triple2_query + " Group by o ORDER BY count(o) DESC", (triple1_synonymns.concat(triple2_synonymns)), function(err, rows) {
            connection.release();
            if (!err) {
                var arr = [];
